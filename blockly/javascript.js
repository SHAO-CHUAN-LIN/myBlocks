...
Blockly.JavaScript['drone_up_and_down'] = function(block) {
  ...
  if(value_status == "take_off")
    var code = 'send_data("0x24,0x4d,0x3c,0x10,0xc8,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xd8");\n'; //1500
  else if(value_status == "landing")
    var code = 'send_data("0x24,0x4d,0x3c,0x10,0xc8,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xe8,0x03,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xdc,0x05,0xd8");\n'; //1000
//   var code = "robotfly_status('"+ value_lock_status +"')";
//   return [code, Blockly.JavaScript.ORDER_NONE];
  return code;
};
