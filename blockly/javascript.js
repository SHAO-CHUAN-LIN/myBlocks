...
Blockly.JavaScript['robofly_go_straight'] = function(block) {
  ...
  if(value_status == "straight")
    var code = 'send_data("0x24,0x4D,0x3C,0x10,0xC8,0xDC,0x05,0x08,0x07,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0x5B");\n'+ //1800(1500t)
...
Blockly.JavaScript['robofly_move'] = function(block) {
  ...
  if(value_status == "right")
    var code = 'send_data("0x24,0x4D,0x3C,0x10,0xC8,0x08,0x07,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0x5B");\n'+ //1800(1500t)
...
//                 'await delay('+ value_time +');\n';
    ...
    var code = 'send_data("0x24,0x4D,0x3C,0x10,0xC8,0xB0,0x04,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0xDC,0x05,0x10");\n'+ //1200(1500t)
