document.write('<input type="button" id="gamebutton_webserial_open" style="z-index:999" value="選擇序列埠">');

let serial_buttonRequest = document.getElementById('gamebutton_webserial_open'); //儲存button回傳的值
